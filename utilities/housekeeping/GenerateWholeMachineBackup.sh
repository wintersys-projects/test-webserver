...
do
  ...
  cd ${HOME}/runtime  
  /usr/bin/tar -cpf ${HOME}/machinedump/${archive_name}_runtime.tar . 
  ...
  /usr/bin/tar -cpf ${HOME}/machinedump/${archive_name}_backup.tar --exclude="${HOME}/machinedump/*" --exclude='/var/www/html/*' --exclude='dev/*' --exclude='proc/*' --exclude='sys/*' --exclude='tmp/*' --exclude='run/*' --exclude='mnt/*' --exclude='media/*' --exclude='lost+found/*' / 
